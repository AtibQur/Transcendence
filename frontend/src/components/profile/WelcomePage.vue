<template>
  ...
  <div class="welcome-text">
    ...
    <router-link class="custom-link" to="/chat">Chat</router-link> your friends, have a look at the <router-link class="custom-link" to="/leaderboard">leaderboard</router-link> or check out your stats and achievements on your <router-link class="custom-link" to="/profile">profile</router-link>.
    <br>Change your username or enable Two-Factor authentication <router-link class="custom-link" to="/profile">here</router-link>.
    <br><br>
