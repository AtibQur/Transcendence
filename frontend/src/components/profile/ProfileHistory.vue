    ...
    <div class="border">
      <div class="border-text">
        ...
        <div class="border-value blue-text player-username">
            <div v-if="props.username === match.player.username">You</div>
            <div v-else-if="props.username != match.player.username"> {{ match.player.username }}</div>
          </div>
          ...
          <div class="border-value blue-text enemy-username">
            <div v-if="props.username === match.player.username">{{ match.opponent.username }}</div>
            <div v-else-if="props.username != match.player.username"> You </div>
          </div>
        </div>
      </div>
    </div>
